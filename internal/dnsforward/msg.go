...
// genAnswerSVCB creates an SVCB answer record.
func (s *Server) genAnswerSVCB(ctx context.Context, req *dns.Msg, svcb *rules.DNSSVCB) (ans *dns.SVCB) {
	return &dns.SVCB{
